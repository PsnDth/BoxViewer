...
var CollisionBoxRenderer = {
	...
	_fixBox: function(cbox:CollisionBox, entity:Entity) {
		...
		var width = cbox.width * entity.getScaleX();
		var height = cbox.height * entity.getScaleY();
		...
		fixed_box_pos = Util.rotatePointAroundPivot(fixed_box_pos, entity_pivot, entity_rotation);
...
var CameraViewHelper = {
	...
	_tick: () -> {
		...
		var region = CameraViewHelper._getRegion();
...
// TODO:
// - scale support
// - windboxes should not hit buttons
// - move up bottom  boundary for FD area
